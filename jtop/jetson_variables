...
# Reference:
# 1. https://github.com/rbonghi/jetson_stats/issues/48
# 2. https://github.com/rbonghi/jetson_stats/issues/57
jetson_board()
{
    ...
    case $JETSON_BOARD in
        *2180*) JETSON_TYPE="TX1" ;;
        ...
        P2888-0060*) JETSON_TYPE="AGX Xavier 8GB" ;;
        P2888*) JETSON_TYPE="AGX Xavier" ;;
        P3448-0020*) JETSON_TYPE="Nano" ;;
        P3448*) JETSON_TYPE="Nano (Developer Kit Version)" ;;
        P3668*) JETSON_TYPE="Xavier NX" ;;
        *) JETSON_TYPE="" ;;
    esac
